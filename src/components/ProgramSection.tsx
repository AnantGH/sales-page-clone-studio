      ...
      <div className="bg-card rounded-lg p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-lg">
            (Everything you need to attain financial freedom and change your life forever with Real Estate)
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="ml-4 space-y-2 text-muted-foreground">
              ...
              <p>4. An archived library of coaching calls and exclusive training content</p>
              <p>5. A supportive online community of active Real Estate Investors</p>
            </div>
          </div>
